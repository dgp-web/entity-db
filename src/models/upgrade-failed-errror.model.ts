export function createUpgradeFailedErrorMessage(payload: {
    readonly currentVersion: number;
    readonly targetVersion: number;
}): string {
    return `An upgrade is required because the target database version ${payload.targetVersion} exceeds the current version ${payload.currentVersion}.
...
export class UpgradeFailedError extends Error {
    ...
    constructor(payload: {
        ...
        super(createUpgradeFailedErrorMessage(payload));
    }
